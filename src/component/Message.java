...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType,String message){
        ...
        if(messageType==MessageType.SUCCESS){
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/images/check.png"))); 
        }
        else{
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/images/cross.png"))); 
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(lbMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 250, Short.MAX_VALUE)
        );
...
protected void paintComponent(Graphics grphcs){
    ...
    if(messageType==MessageType.SUCCESS){
        g2.setColor(new Color(15,174,31));
    }
    else{
